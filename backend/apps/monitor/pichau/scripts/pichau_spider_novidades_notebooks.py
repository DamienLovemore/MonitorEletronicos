...
# Pichau na categoria de notebooks, e apitar produtos encontrados.
# -----------------------------------------------------------------

class PichauNovidadesNotebooks:
    def __init__(self):
        # A url da página onde seram pegos os dados
        self.url = url_pichau_novidades_notebooks
