...
# lançamentos da pichau. E apitar produtos novos encontrados.
# -----------------------------------------------------------------

class PichauNovidadesAPI:
    def __init__(self):
    ...
    def requisicao(self, url: str):
        try:
            ...
            products = script_page_data["data"]["products"]["items"]
    ...
    def scraping(self):
        ...
        try:
            ...
            todos_produtos = self.requisicao(url_pichau_novidades_api)
