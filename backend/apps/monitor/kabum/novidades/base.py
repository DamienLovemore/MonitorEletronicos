...
from apps.helpers.settings_vars import webhook_kabum_novidades, keywords_kabum_restock
...
class KabumNovidades:
    def __init__(self, log):
        ...
        self.url_discord = webhook_kabum_novidades
    ...
    def requisicao(self, url: str):
        try:
            ...
            headers = {
                ...
                'referer': 'https://www.kabum.com.br/gamer/xbox-one',
            ...
            products = page_content.find_all("div", attrs={"class": "productCard"})
    ...
    def scraping(self, url: str, page: int):
        ...
        try:
            ...
            for produto in todos_produtos:
                nome = produto.find("h2", attrs={"class": "nameCard"}).next_element

                imagem = produto.find("img", attrs={"class": "imageCard"})
                imagem = imagem.get("src")

                url_produto = produto.find("a").get("href")
                ...
                preco = produto.find("span", attrs={"class": "priceCard"}).next_element
    ...
    def check_keywords(self, url_produto: str):
        ...
        for kw in keywords_kabum_restock:
            if kw in url:
                count += 1
    ...
    def base_criar_modelos(self, product: dict, plataforma: str):
        ...
        try:
            ...
            modelos_produtos_duplicados = ProdutoEletrInf.objects.filter(nome=product["nome"], imagem=product["imagem"],
                                                                         url_produto=product["url_produto"],
                                                                         plataforma=plataforma)
    ...
    def criar_modelos(self, products_list: list):
        ...
        try:
            ...
            for product in products_list:
                ...
                produto_novo = self.base_criar_modelos(product, "kabum_novidades")
                ...
                self.base_criar_modelos(product, "kabum_restock")
        except Exception as error:
